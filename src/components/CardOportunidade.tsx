...
export function CardOportunidade({ o }: { o: Oportunidade }) {
  return (
    <Link
      to="/app/oportunidades/$slug"
      params={{ slug: o.slug }}
      className="group flex flex-col overflow-hidden rounded-2xl border border-border bg-card transition-colors hover:border-gold/40"
    >
